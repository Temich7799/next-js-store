...
export const CAROUSEL_LAST_SEEN_PRODUCTS_TITLE = 'Last seen';
...
export const SELECT_PLACEHOLDER = 'Select from list';
...
export const CLIENT_CONTACTS_LAST_NAME_TITLE = 'Last Name';

export const CLIENT_CONTACTS_PHONE_TITLE = 'Phone';
export const CLIENT_CONTACTS_PHONE_ERROR_MESSAGE = 'Enter number in correct format';
